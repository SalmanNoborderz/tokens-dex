...
contract TokenDEXRouter is ISunswapV2Router02 {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, 'SunswapV2Router: FORBIDDEN');
        _;
    }

    modifier onlyWhitelisted() {
        require(whitelistedUsers[msg.sender], 'SunswapV2Router: NOT_WHITELISTED');
        _;
    }
    ...
    function transferOwnership(address newOwner) external onlyOwner {
        require(newOwner != address(0), 'SunswapV2Router: INVALID_OWNER');
    ...
    function addLiquidity(
        ...
        address to,
        uint deadline
    ) external virtual payable override ensure(deadline) onlyWhitelisted() returns (uint amountA, uint amountB, uint liquidity) {
    ...
    function addLiquidityETH(
        ...
        address to,
        uint deadline
    ) external virtual override payable ensure(deadline) onlyWhitelisted() returns (uint amountToken, uint amountETH, uint liquidity) {
    ...
    function removeLiquidity(
        ...
        address to,
        uint deadline
    ) public virtual override ensure(deadline) onlyWhitelisted() returns (uint amountA, uint amountB) {
        address pair = SunswapV2Library.pairFor(factory, tokenA, tokenB);
    ...
    function removeLiquidityETH(
        ...
        address to,
        uint deadline
    ) public virtual override ensure(deadline) onlyWhitelisted() returns (uint amountToken, uint amountETH) {
    ...
    ) external virtual override onlyWhitelisted() returns (uint amountA, uint amountB) {
        address pair = SunswapV2Library.pairFor(factory, tokenA, tokenB);
    ...
    function removeLiquidityETHWithPermit(
        ...
        uint deadline,
        bool approveMax, uint8 v, bytes32 r, bytes32 s
    ) external virtual override onlyWhitelisted() returns (uint amountToken, uint amountETH) {
        address pair = SunswapV2Library.pairFor(factory, token, WETH);
        uint value = approveMax ? uint(-1) : liquidity;
        ISunswapV2ERC20(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
    ...
    function removeLiquidityETHSupportingFeeOnTransferTokens(
        ...
        address to,
        uint deadline
    ) public virtual override onlyWhitelisted() ensure(deadline) returns (uint amountETH) {
    ...
    function removeLiquidityETHWithPermitSupportingFeeOnTransferTokens(
        ...
        uint deadline,
        bool approveMax, uint8 v, bytes32 r, bytes32 s
    ) external virtual override onlyWhitelisted() returns (uint amountETH) {
        address pair = SunswapV2Library.pairFor(factory, token, WETH);
        uint value = approveMax ? uint(-1) : liquidity;
        ISunswapV2ERC20(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
    ...
    function swapExactTokensForTokens(
        ...
        address to,
        uint deadline
    ) external virtual override ensure(deadline) onlyWhitelisted() returns (uint[] memory amounts) {
