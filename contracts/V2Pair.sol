...
contract SunswapV2Pair is ISunswapV2Pair, SunswapV2ERC20 {
    ...
    function transferOwnership(address newOwner) external onlyOwner {
        ...
        require(newOwner != address(0), 'SunswapV2Pair: INVALID_OWNER');
    ...
    // this low-level function should be called from a contract which performs important safety checks
    function burn(address to) external override lock onlyRouter() returns (uint amount0, uint amount1) {
        (uint112 _reserve0, uint112 _reserve1,) = getReserves(); // gas savings
    ...
    // this low-level function should be called from a contract which performs important safety checks
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external override lock onlyRouter() {
